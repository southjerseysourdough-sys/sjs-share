        ...
        <div className="p-6">
          ...
          <div className="flex gap-3">
            <a
              ...
              className="inline-flex items-center justify-center px-5 py-2.5 rounded-lg bg-[#2b2b2b] text-white text-sm font-semibold no-underline hover:bg-[#111111] transition-colors"
            >
              View Product
            </a>
